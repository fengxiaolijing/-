...
| -------- | ----------- | ------------- | ------------------------------- | ----------------------------------- |
| redis    | 6379        | uc123456      |                                 |                                     |
| mysql    | 3306        | root/uc123456 | /root/scripts/uc/mysql/packages | /root/scripts/uc/mysql/tools/my.cnf |
...
```
root@cf2f0437c3f3:/# mysql -uroot -puc123456
...
mysql> ALTER USER 'root'@'%' IDENTIFIED WITH mysql_native_password BY 'uc123456';
...
```
mysqldump -uroot -p123456 uc > 1023uc.sql
```

导入数据

```
 mysql -uroot -puc123456 -h10.0.110.201 uc < 1023uc.sql
```
...
Database changed
MySQL [uc]> show tables;
+---------------------------------------+
| Tables_in_uc                          |
+---------------------------------------+
| ehr_org                               |
| ehr_user                              |
| tb_schedule_employee                  |
| temp_ccemp                            |
| tmp_idcard                            |
| tmp_tel                               |
| uc_administrative_division            |
.....
.....
.....
```
...
```
 sh run.sh -e canal.instance.master.address=10.0.110.201:3306 -e canal.instance.dbUsername=root -e canal.instance.dbPassword=uc123456 -e canal.instance.connectionCharset=UTF-8 -e canal.instance.tsdb.enable=true -e canal.instance.gtidon=false -e canal.admin.port=11111 -e canal.instance.defaultDatabaseName=uc
```
